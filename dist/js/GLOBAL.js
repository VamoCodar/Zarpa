...
})({"cAm2H":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "0aed03cfb133bf36";
...
},{}],"84iEb":[function(require,module,exports) {
const GLOBAL = {
    ...
    setSelectedOptionInChoices: (choice, value)=>{
        function pegaResponsavel(choice) {
            if (choice.value == value) choice.selected = true;
    ...
    translatefilepond: {
        ...
        labelInvalidField: "O Tipo de arquivo \xe9 invalido",
...
},{}]},["cAm2H","84iEb"], "84iEb", "parcelRequire5701")
